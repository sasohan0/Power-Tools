      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10">
        <div className="card w-72 sm:w-96 bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <p>
              I will Keep component state local where needed. Using components
              to minimize repeated actions. Dynamic import() and code splitting.
              Load images in lazy loading. Using production build before
              development. I will avoid anonymous functions.
            </p>
          </div>
        </div>
        <div className="card w-72 sm:w-96 bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <p>
              ...
              hard. useEffect is used for reading updates of state. Context api
              is also a way of managing state
            </p>
          </div>
        </div>
        <div className="card w-72 sm:w-96 bg-base-100 shadow-xl">
        ...
        <div className="card w-72 sm:w-96 bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <p>
              Because React only works in one way render. When we call
              setProducts it changes the state of products and tells react to
              re-render the state of products. If our products are in an object
              initially and we need to change only one element we can call and
              change the value of that property using setProducts but doing it
              manually needs to declare the entire object.
            </p>
          </div>
        </div>
        <div className="card w-72 sm:w-96 bg-base-100 shadow-xl">
        ...
        <div className="card w-72 sm:w-96 bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <p>
              ...
              of a function or component for a given input. For React
              components, this means checking that the component renders
              correctly for the specified props. Writing unit tests means that
              we write code that verifies that our code works as expected.
            </p>
          </div>
        </div>
      </div>
